...
int sampleCounter = 1;
// Create every item in the snapshot list
t_SnapShot* OneSnapShot()
{
	...
	GetProcessInfo();
	// Sorts the process list before i reset it
	sortingProcessList();
...
// Create snapshot and conclude all processes memory that went through the computer for 20 seconds
...
// create the snapshot list Shead-Stail
